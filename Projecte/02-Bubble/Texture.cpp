...
/*Texture::~Texture() 
{
	glDeleteVertexArrays(1, &texId);
	glDisableVertexArrayAttrib(GL_TEXTURE_2D, wrapS);
	glDisableVertexArrayAttrib(GL_TEXTURE_2D, wrapT);
	glDisableVertexArrayAttrib(GL_TEXTURE_2D, minFilter);
	glDisableVertexArrayAttrib(GL_TEXTURE_2D, magFilter);
}*/
